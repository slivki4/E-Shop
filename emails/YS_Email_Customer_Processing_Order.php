...
if ( ! class_exists( 'YS_Email_Customer_Processing_Order', false ) ) :

	class YS_Email_Customer_Processing_Order extends WC_Email_Customer_Processing_Order {
...
return new YS_Email_Customer_Processing_Order();